CREATE PROC CreateVoucher(@activationCode int, @gameId int) AS
BEGIN
	...
	INSERT INTO Voucher(ActivationCode, GameID)
	VALUES(@activationCode, @gameId)
END
GO
GRANT EXECUTE ON CreateVoucher TO ArcadeIQApp 
